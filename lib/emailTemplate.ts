			...
			<table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
				<tbody>
					<tr>
						...
						<div style="background-color:#ffffff;border:1px solid #e5e7eb;border-radius:4px;padding:8px;display:inline-block;"><img alt="Attendee QR Code" src="${safeQrUrl}" style="display:block;width:140px;height:140px;border:0;" /></div>
						</td>
			...
			<table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;font-size:14px;">
				<tbody>
					<tr>
						...
						<td style="padding:6px 0;vertical-align:top;">Open your attendee profile via the QR code or button above.</td>
					</tr>
					<tr>
